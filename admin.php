...
<td><strong><?=$job['applications']?></strong><?php if($limit!==null): ?><span class="meta"> / <?=$limit?></span><div class="cap-bar"><span style="width:<?=$pct?>%"></span></div><?php if($remaining===0): ?><span class="badge full">Target met</span><?php else: ?><span class="meta small"><?=$remaining?> to target</span><?php endif; ?><?php else: ?><span class="meta small">Unlimited</span><?php endif; ?></td>
